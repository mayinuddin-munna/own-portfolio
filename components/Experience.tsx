      ...
      <div className="container">
        <div className="row g-4 g-xl-5">
          ...
          <div className="col-12 col-xl-9 col-xxl-10">
            <h2 className="display-8 fw-medium mb-0">
            ...
            <div className="row g-3">
              {clientsData.map((client, index) => (
                <div key={index} className="col-6 col-md-4">
                  <div className="client-box bg-lighter-30 border-dashed border-radius p-4 px-lg-5 h-100 d-flex align-items-center justify-content-center">
