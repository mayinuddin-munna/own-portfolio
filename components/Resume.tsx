            ...
            {resumeData.experience.map((job, index) => (
              <div key={index} className="row g-2 g-lg-4 mt-3 mt-lg-1">
                ...
                <div className="col-12 col-lg-9">
                  <h4>
                    {job.title}{" "}
                    <span className="fst-italic fw-medium text-lighter-30">
                      @{job.company}
                    </span>
                  </h4>
                  <p>{job.description}</p>
            ...
            <div className="row g-4">
              {resumeData.education.map((edu, index) => (
                <div key={index} className="col-12 col-lg-6 col-xxl-12">
                  <div className="bg-theme-secondary border-radius box-shadow p-4 p-md-5 icon-3xl h-100 d-flex flex-column">
                    <i className={` ${edu.icon} text-white-50`}></i>
                    <div className="mt-3 mt-lg-4 flex-grow-1">
