      ...
      <div className="row g-5">
        <div className="col-12 col-lg-5 order-lg-2">
          <div className="bg-theme-secondary p-4 p-md-5 border-radius box-shadow">
            ...
            <div className="mt-4">
              <h5 id="email-1" className="fw-medium mb-0">
                Email:
              </h5>
            ...
            <div className="mt-4">
              <h5 id="address" className="fw-medium mb-0">
                Address:
              </h5>
          ...
          <div className="contact-form">
            <form id="contactform" onSubmit={handleSubmit}>
              ...
              <div className="submit-result">
                {status === "success" && (
                  <p id="success" className="show-result">
                    Thank you! Your Message has been sent.
                  </p>
                )}
                {status === "error" && (
                  <p id="error" className="show-result">
