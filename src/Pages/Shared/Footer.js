...
const Footer = () => {
    return (
        <div>
            <footer className="footer p-10 text-neutral-content " style={{ backgroundColor: '#050c14' }}>
                <div>
                    <img className='w-12' src={LOGO} alt="" />
                    <p>Native Designer &<br /> Front-End Web Developer.</p>
                </div>
                <div>
            ...
            <p className='text-center text-neutral-content' style={{ backgroundColor: '#050c14' }}>© {(new Date().getFullYear())} - All right reserved</p>
        </div>
    );
};
