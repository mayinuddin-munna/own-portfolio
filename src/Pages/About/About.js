...
const About = () => {
    return (
        <div className="hero min-h-screen mt-[10px] z10">
            <div className="hero-content flex-col lg:flex-row-reverse">
                <img src={profile} alt='profile' className="max-w-sm rounded-full w-58 shadow-2xl" />
                <div>
                    <div className="card-body lg:mx-20 md:mx-20">
                        <Slide bottom>
                            ...
                            <div className='flex gap-5 mt-5'>
                                ...
                                <Button><FaDownload className='mr-3 mt-1' />resume</Button>
                            </div>
                        </Slide>
                    </div>
                </div>
